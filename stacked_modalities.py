...
df_grad_LGG = gradcam_coef('LGG', drive, modality, pretrained_model, stacked=True)
df_grad_HGG = gradcam_coef('HGG', drive, modality, pretrained_model, stacked=True)
df_grad_HGG.to_csv(f"{home_dir}/explain_datasets/grad_coef_{model}_{modality}.csv", index=False)

df_ggrad_LGG = guided_grad_coef('LGG', drive, modality, pretrained_model, stacked=True)
df_ggrad_HGG = guided_grad_coef('HGG', drive, modality, pretrained_model, stacked=True)
df_ggrad_HGG.to_csv(f"{home_dir}/explain_datasets/guidgrad_coef_{model}_{modality}.csv", index=False)

df_xrai_LGG = xrai_coef('LGG', drive, modality, pretrained_model, stacked=True)
df_xrai_HGG = xrai_coef('HGG', drive, modality, pretrained_model, stacked=True)
df_xrai_HGG.to_csv(f"{home_dir}/explain_datasets/xrai_coef_{model}_{modality}.csv", index=False)

df_lime_LGG = lime_coef('LGG', drive, modality, pretrained_model, stacked=True)
df_lime_HGG = lime_coef('HGG', drive, modality, pretrained_model, stacked=True)
